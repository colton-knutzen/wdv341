<?php
    ...
    $sql = "SELECT events_name, events_description FROM wdv341_event";     //all rows in that table
    ...
    $stmt->setFetchMode(PDO::FETCH_ASSOC);      //setting ALL fetch commands to return associative array
        ...
        echo '<p> This is a try-catch block. It failed because the table was misspelled. Error: ' . $e->getMessage() . '</p>';
    }
